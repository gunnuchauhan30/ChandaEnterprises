...
class Settings(BaseSettings):
    ...
    # --- Email / SMTP ---
    # RESEND_API_KEY takes priority when set: Resend's HTTPS API is used
    # instead of raw SMTP, because Railway blocks outbound SMTP ports on
    # every plan (free and paid) -- SMTP settings below are kept only as a
    # fallback for environments that don't block SMTP (e.g. a real VPS).
    RESEND_API_KEY: str = ""
